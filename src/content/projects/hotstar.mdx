...
Project setup at Hotstar's engineering org meant manual repo creation, CI/CD pipeline configuration, branch protection rules, secrets management — every new project incurred the same friction. Engineers spent hours on the kind of work the tooling should just *handle*.
